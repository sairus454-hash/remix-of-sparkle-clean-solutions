...
const PriceSection = ({ defaultAllOpen = false, showFilters = false, excludeCategoryIds = [] }: PriceSectionProps) => {
  ...
  const allCategories: CategorySection[] = [
    ...
    },
    {
      ...
      icon: BedDouble,
      items: [
        { id: 'mattressSingle', name: t.prices.items.mattressSingleDry, price: 130, image: calcMattressSingle },
        { id: 'mattressSingleDry2', name: t.prices.items.mattressSingleDry2, price: 200, image: calcMattressSingle },
        { id: 'mattressDouble', name: t.prices.items.mattressDoubleDry, price: 200, image: calcMattressDouble },
        { id: 'mattressDoubleDry2', name: t.prices.items.mattressDoubleDry2, price: 300, image: calcMattressDouble },
        { id: 'bedHeadboardM', name: t.prices.items.bedHeadboard, price: 100, image: calcHeadboard },
        { id: 'bedFrameM', name: t.prices.items.bedFrame, price: 100, image: calcBedframe },
      ],
    },
    {
      id: 'leather',
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'tileCleaning', name: t.prices.items.tileCleaning, price: 15, image: calcTileCleaning, unit: 'm²' },
        { id: 'woodFloorCleaning', name: t.prices.items.woodFloorCleaning, price: 15, image: calcWoodFloorCleaning, unit: 'm²' },
