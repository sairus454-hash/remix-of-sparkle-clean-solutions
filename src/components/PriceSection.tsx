  ...
  const categories: CategorySection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'sofa2', name: t.prices.items.sofa2, price: 121, originalPrice: 135, image: calcSofa2, promoBadge: '🔥 -10%' },
        { id: 'sofa3', name: t.prices.items.sofa3, price: 148, originalPrice: 164, image: calcSofa3, promoBadge: '🔥 -10%' },
        { id: 'sofaCorner', name: t.prices.items.sofaCorner, price: 178, originalPrice: 198, image: calcSofaCorner, promoBadge: '🔥 -10%' },
        ...
        { id: 'bedHeadboard', name: t.prices.items.bedHeadboard, price: 73, originalPrice: 81, image: calcHeadboard, promoBadge: '🔥 -10%' },
        { id: 'bedFrame', name: t.prices.items.bedFrame, price: 73, originalPrice: 81, image: calcBedframe, promoBadge: '🔥 -10%' },
      ],
    },
    {
      id: 'leather',
      ...
      icon: Armchair,
      items: [
        { id: 'leatherPouf', name: t.prices.items.leatherPouf, price: 41, originalPrice: 45, image: calcLeatherPouf, promoBadge: '🔥 -10%' },
        { id: 'leatherChair', name: t.prices.items.leatherChair, price: 41, originalPrice: 45, image: calcLeatherChair, promoBadge: '🔥 -10%' },
        { id: 'leatherArmchair', name: t.prices.items.leatherArmchair, price: 73, originalPrice: 81, image: calcLeatherArmchair, promoBadge: '🔥 -10%' },
    ...
    },
    {
      ...
      icon: BedDouble,
      items: [
        { id: 'mattressSingle', name: t.prices.items.mattressSingleDry, price: 113, originalPrice: 126, image: calcMattressSingle, promoBadge: '🔥 -10%' },
        { id: 'mattressSingleDry2', name: t.prices.items.mattressSingleDry2, price: 178, originalPrice: 198, image: calcMattressSingle, promoBadge: '🔥 -10%' },
        { id: 'mattressDouble', name: t.prices.items.mattressDoubleDry, price: 175, originalPrice: 194, image: calcMattressDouble, promoBadge: '🔥 -10%' },
        { id: 'mattressDoubleDry2', name: t.prices.items.mattressDoubleDry2, price: 239, originalPrice: 266, image: calcMattressDouble, promoBadge: '🔥 -10%' },
        { id: 'bedHeadboardM', name: t.prices.items.bedHeadboard, price: 73, originalPrice: 81, image: calcHeadboard, promoBadge: '🔥 -10%' },
        { id: 'bedFrameM', name: t.prices.items.bedFrame, price: 73, originalPrice: 81, image: calcBedframe, promoBadge: '🔥 -10%' },
      ],
    },
    {
      id: 'auto',
