  ...
  const categories: CategorySection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'bedHeadboardM', name: t.prices.items.bedHeadboard, price: 75, originalPrice: 80, image: calcHeadboard, promoBadge: '🔥 -10%' },
        { id: 'bedFrameM', name: t.prices.items.bedFrame, price: 75, originalPrice: 80, image: calcBedframe, promoBadge: '🔥 -10%' },
      ],
    },
    {
      id: 'auto',
