  ...
  const categories: CategorySection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'sofaCorner', name: t.prices.items.sofaCorner, price: 156, originalPrice: 173, image: calcSofaCorner, promoBadge: '🔥 -10%' },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'mattressDouble', name: t.prices.items.mattressDoubleDry, price: 146, originalPrice: 162, image: calcMattressDouble, promoBadge: '🔥 -10%' },
        { id: 'mattressDoubleDry2', name: t.prices.items.mattressDoubleDry2, price: 227, originalPrice: 252, image: calcMattressDouble, promoBadge: '🔥 -10%' },
