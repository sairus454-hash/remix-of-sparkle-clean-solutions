  ...
  const categories: PriceAccordionCategory[] = [
    {
      ...
      icon: Home,
      items: [
        { name: `${t.cleaning?.standardCleaning || 'Стандартная уборка'} (${t.cleaning?.pricePerMeter || 'за м²'})`, price: 7, unit: 'm²', icon: Home },
        { name: `${t.cleaning?.generalCleaning || 'Генеральная уборка'} (${t.cleaning?.pricePerMeter || 'за м²'})`, price: 10, unit: 'm²', icon: Sparkles },
        { name: `${t.cleaning?.standardCleaning || 'Стандартная уборка'} 50 м²`, price: 350, icon: Home },
        { name: `${t.cleaning?.standardCleaning || 'Стандартная уборка'} 80 м²`, price: 560, icon: Home },
        { name: `${t.cleaning?.standardCleaning || 'Стандартная уборка'} 100 м²`, price: 700, icon: Home },
    ...
    },
    {
      ...
      items: [
        ...
        { name: t.prices.items.autoOzone, price: 120, icon: Wind },
    ...
    },
    {
      ...
      icon: Wind,
      items: [
        { name: t.prices.items.ozone1room, price: 144, icon: Home },
        { name: t.prices.items.ozone2room, price: 240, icon: Home },
        { name: t.prices.items.ozone3room, price: 360, icon: Home },
        { name: t.prices.items.ozoneOfficeSmall, price: 300, icon: LayoutGrid },
        { name: t.prices.items.ozoneOfficeLarge, price: 480, icon: Maximize2 },
      ],
      note: `${t.handyman?.minOrderNote || 'Минимальный заказ для Вроцлава и пригорода (R=10 km) — 180 zł'}\n${t.handyman?.minOrderNoteOther || 'Минимальный заказ для других населённых пунктов — 300 zł'}`,
    },
    {
