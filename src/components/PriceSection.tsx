...
const PriceSection = ({ defaultAllOpen = false, showFilters = false, excludeCategoryIds = [] }: PriceSectionProps) => {
  ...
  const allCategories: CategorySection[] = [
    ...
    },
    {
      ...
      icon: BedDouble,
      items: [
        { id: 'mattressSingle', name: t.prices.items.mattressSingleDry, price: 115, image: calcMattressSingle },
        { id: 'mattressSingleDry2', name: t.prices.items.mattressSingleDry2, price: 180, image: calcMattressSingle },
        { id: 'mattressDouble', name: t.prices.items.mattressDoubleDry, price: 175, image: calcMattressDouble },
        { id: 'mattressDoubleDry2', name: t.prices.items.mattressDoubleDry2, price: 240, image: calcMattressDouble },
        { id: 'bedHeadboardM', name: t.prices.items.bedHeadboard, price: 80, image: calcHeadboard },
        { id: 'bedFrameM', name: t.prices.items.bedFrame, price: 80, image: calcBedframe },
      ],
    },
    {
      id: 'leather',
      ...
      icon: Armchair,
      items: [
        { id: 'leatherPouf', name: t.prices.items.leatherPouf, price: 40, image: calcLeatherPouf },
        { id: 'leatherChair', name: t.prices.items.leatherChair, price: 40, image: calcLeatherChair },
        { id: 'leatherArmchair', name: t.prices.items.leatherArmchair, price: 75, image: calcLeatherArmchair },
        { id: 'leatherSofa2', name: t.prices.items.leatherSofa2, price: 145, image: calcLeatherSofa2 },
        { id: 'leatherSofa3', name: t.prices.items.leatherSofa3, price: 180, image: calcLeatherSofa3 },
        { id: 'leatherSofaCorner', name: t.prices.items.leatherSofaCorner, price: 220, image: calcLeatherCorner },
        { id: 'leatherChairSwivel', name: t.prices.items.leatherChairSwivel, price: 60, image: calcLeatherChairSwivel },
      ],
    },
    {
      id: 'auto',
