...
const PriceItem = forwardRef<HTMLDivElement, PriceItemProps>(({ name, price, from, currency, unit, icon: Icon }, ref) => {
  return (
    <div ref={ref} className="flex items-center justify-between py-3 sm:py-4 border-b border-border last:border-0 hover:bg-accent/30 active:bg-accent/50 transition-colors px-2 sm:px-4 -mx-2 sm:-mx-4 rounded-lg touch-manipulation">
