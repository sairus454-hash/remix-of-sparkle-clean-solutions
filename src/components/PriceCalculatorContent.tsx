  ...
  const baseCategories: Category[] = [
    {
      ...
      items: [
        ...
        { id: 'sofaCornerLarge', name: t.prices.items.sofaCornerLarge, price: 260 },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'mattressDoubleDry2', name: t.prices.items.mattressDoubleDry2, price: 300 },
    ...
    },
    {
    ...
    },
     {
       ...
       items: [
         ...
         { id: 'glassPanels', name: t.windows?.items?.glassPanels || 'Mycie paneli szklanych', price: 10, unit: 'm²' },
       ],
     },
     {
       id: 'handyman',
