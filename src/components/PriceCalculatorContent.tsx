  ...
  const categories: Category[] = [
    {
      ...
      items: [
        { id: 'pouf', name: t.prices.items.pouf, price: 36 },
        { id: 'chair', name: t.prices.items.chair, price: 36 },
        { id: 'armchair', name: t.prices.items.armchair, price: 63 },
        { id: 'pillow', name: t.prices.items.pillow, price: 14 },
        { id: 'sofa2', name: t.prices.items.sofa2, price: 126 },
        { id: 'sofa3', name: t.prices.items.sofa3, price: 153 },
        { id: 'sofaCorner', name: t.prices.items.sofaCorner, price: 180 },
        { id: 'sofaCornerLarge', name: t.prices.items.sofaCornerLarge, price: 225 },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'leatherChair', name: t.prices.items.leatherChair, price: 45 },
        { id: 'leatherPillow', name: t.prices.items.leatherPillow, price: 18 },
        { id: 'leatherArmchair', name: t.prices.items.leatherArmchair, price: 81 },
        { id: 'leatherSofa2', name: t.prices.items.leatherSofa2, price: 162 },
        { id: 'leatherSofa3', name: t.prices.items.leatherSofa3, price: 198 },
        { id: 'leatherSofaCorner', name: t.prices.items.leatherSofaCorner, price: 225 },
      ],
    },
    {
      id: 'auto',
    ...
    },
    {
      ...
      items: [
        { id: 'mattressDouble', name: t.prices.items.mattressDouble, price: 162 },
        { id: 'mattressSingle', name: t.prices.items.mattressSingle, price: 126 },
        { id: 'bedHeadboard', name: t.prices.items.bedHeadboard, price: 90 },
        { id: 'bedFrame', name: t.prices.items.bedFrame, price: 90 },
        { id: 'mattressSingleDry', name: t.prices.items.mattressSingleDry, price: 126 },
        { id: 'mattressSingleDry2', name: t.prices.items.mattressSingleDry2, price: 198 },
        { id: 'mattressDoubleDry', name: t.prices.items.mattressDoubleDry, price: 162 },
        { id: 'mattressDoubleDry2', name: t.prices.items.mattressDoubleDry2, price: 252 },
     ...
     },
     {
       ...
       icon: <Wrench className="w-5 h-5" />,
        items: [
          ...
          // Услуги огородника
          { id: 'lawnMowing', name: t.handyman?.calcItems?.lawnMowing || 'Покос травы', price: 15, unit: 'm²', subcategory: t.handyman?.subcategories?.gardening || '🌿 Услуги огородника' },
