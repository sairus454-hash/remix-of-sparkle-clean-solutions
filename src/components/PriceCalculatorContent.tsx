  ...
  const baseCategories: Category[] = [
    {
      ...
      items: [
        ...
        { id: 'chairSeat', name: t.prices.items.chairSeat, price: 20 },
        { id: 'chairWithBack', name: t.prices.items.chairWithBack, price: 30 },
        { id: 'chairConference', name: t.prices.items.chairConference, price: 40 },
        { id: 'chairSwivel', name: t.prices.items.chairSwivel, price: 50 },
        { id: 'chair', name: t.prices.items.chair, price: 30 },
        { id: 'armchair', name: t.prices.items.armchair, price: 80 },
        ...
        { id: 'sofaCornerLarge', name: t.prices.items.sofaCornerLarge, price: 240 },
        { id: 'kitchenCorner', name: t.prices.items.kitchenCorner, price: 150 },
        { id: 'carpet', name: t.prices.items.carpet, price: 23, unit: 'm²' },
        { id: 'bedHeadboard', name: t.prices.items.bedHeadboard, price: 90 },
        { id: 'bedFrame', name: t.prices.items.bedFrame, price: 90 },
    ...
    },
    {
      ...
      items: [
        { id: 'mattressDouble', name: t.prices.items.mattressDouble, price: 200 },
        { id: 'mattressSingle', name: t.prices.items.mattressSingle, price: 130 },
        { id: 'bedHeadboard', name: t.prices.items.bedHeadboard, price: 90 },
        { id: 'bedFrame', name: t.prices.items.bedFrame, price: 90 },
        { id: 'mattressSingleDry', name: t.prices.items.mattressSingleDry, price: 130 },
        { id: 'mattressSingleDry2', name: t.prices.items.mattressSingleDry2, price: 200 },
        { id: 'mattressDoubleDry', name: t.prices.items.mattressDoubleDry, price: 200 },
        { id: 'mattressDoubleDry2', name: t.prices.items.mattressDoubleDry2, price: 270 },
    ...
    },
    {
      ...
      items: [
        { id: 'leatherPouf', name: t.prices.items.leatherPouf, price: 50 },
        ...
        { id: 'leatherSofa2', name: t.prices.items.leatherSofa2, price: 160 },
        { id: 'leatherSofa3', name: t.prices.items.leatherSofa3, price: 200 },
        { id: 'leatherSofaCorner', name: t.prices.items.leatherSofaCorner, price: 230 },
        { id: 'leatherChairSwivel', name: t.prices.items.leatherChairSwivel, price: 70 },
      ],
    },
    {
      id: 'auto',
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'carpetCoveringImpregnation', name: t.prices.items.carpetCoveringImpregnation, price: 3, unit: 'm²' },
        { id: 'tileCleaning', name: t.prices.items.tileCleaning, price: 20, unit: 'm²' },
        { id: 'carpetFloorMedium', name: t.prices.items.carpetFloorMedium, price: 10, unit: 'm²' },
        { id: 'carpetFloorLarge', name: t.prices.items.carpetFloorLarge, price: 7, unit: 'm²' },
      ],
    },
     {
       id: 'windows',
