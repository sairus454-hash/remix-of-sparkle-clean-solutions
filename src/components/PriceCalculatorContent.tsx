  ...
  const categories: Category[] = [
    {
      ...
      items: [
        ...
        { id: 'sofa2', name: t.prices.items.sofa2, price: 121 },
        { id: 'sofa3', name: t.prices.items.sofa3, price: 148 },
        { id: 'sofaCorner', name: t.prices.items.sofaCorner, price: 198 },
    ...
    },
    {
      ...
      items: [
        { id: 'mattressDouble', name: t.prices.items.mattressDouble, price: 194 },
        ...
        { id: 'mattressDoubleDry', name: t.prices.items.mattressDoubleDry, price: 194 },
        { id: 'mattressDoubleDry2', name: t.prices.items.mattressDoubleDry2, price: 266 },
