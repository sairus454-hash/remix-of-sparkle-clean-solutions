  ...
  const baseCategories: Category[] = [
    {
      ...
      items: [
        { id: 'pouf', name: t.prices.items.pouf, price: 30 },
        { id: 'chairSeat', name: t.prices.items.chairSeat, price: 15 },
        { id: 'chairWithBack', name: t.prices.items.chairWithBack, price: 25 },
        { id: 'chairConference', name: t.prices.items.chairConference, price: 30 },
        { id: 'chairSwivel', name: t.prices.items.chairSwivel, price: 45 },
        { id: 'chair', name: t.prices.items.chair, price: 25 },
        { id: 'armchair', name: t.prices.items.armchair, price: 65 },
        { id: 'pillow', name: t.prices.items.pillow, price: 5 },
        { id: 'sofa2', name: t.prices.items.sofa2, price: 130 },
        { id: 'sofa3', name: t.prices.items.sofa3, price: 150 },
        { id: 'sofaCorner', name: t.prices.items.sofaCorner, price: 200 },
        { id: 'sofaCornerLarge', name: t.prices.items.sofaCornerLarge, price: 210 },
        { id: 'kitchenCorner', name: t.prices.items.kitchenCorner, price: 130 },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'leatherChair', name: t.prices.items.leatherChair, price: 40 },
        { id: 'leatherPillow', name: t.prices.items.leatherPillow, price: 15 },
        { id: 'leatherArmchair', name: t.prices.items.leatherArmchair, price: 75 },
        { id: 'leatherSofa2', name: t.prices.items.leatherSofa2, price: 145 },
        { id: 'leatherSofa3', name: t.prices.items.leatherSofa3, price: 180 },
        { id: 'leatherSofaCorner', name: t.prices.items.leatherSofaCorner, price: 205 },
        { id: 'leatherChairSwivel', name: t.prices.items.leatherChairSwivel, price: 60 },
      ],
    },
    {
      id: 'auto',
