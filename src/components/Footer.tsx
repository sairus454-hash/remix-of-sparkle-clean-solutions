        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3">
              ...
              <li>
                <a href="https://mail.google.com/mail/?view=cm&to=sairus454@gmail.com" className="flex items-center gap-2 text-sm text-background/80 hover:text-background transition-colors touch-manipulation py-1">
