    ...
    <section id="promotions" className="py-12 sm:py-20 bg-gradient-section content-auto">
      <div className="container mx-auto px-4">
        <div className="text-center mb-8 sm:mb-12">
          ...
          <div className="inline-block px-6 sm:px-10 py-4 sm:py-6 rounded-2xl sm:rounded-3xl mb-4 sm:mb-6 animate-fade-up" style={glassmorphism}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          ...
          <CircularRevealCard index={0} slow className="h-full">
            <div className="relative overflow-hidden p-6 sm:p-8 rounded-2xl sm:rounded-3xl shadow-card group hover:shadow-glow transition-all duration-500 touch-manipulation h-full hover:scale-[1.02]" style={glassmorphism}>
