    ...
    <div className="fixed right-2 sm:right-4 top-[60px] sm:top-[68px] lg:top-[84px] z-40 flex flex-col items-center gap-2">
      ...
      <div className="flex flex-col items-center gap-1.5">
        ...
        {Date.now() < new Date('2026-03-10T00:00:00Z').getTime() && (
          <div className="relative group w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-pink-500 to-rose-400 flex items-center justify-center shadow-md animate-bounce cursor-default">
