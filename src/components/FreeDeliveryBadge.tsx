...
const FreeDeliveryBadge = () => {
  ...
  const messengerIcons = (
    <>
      ...
      >
        <svg viewBox="0 0 24 24" className="w-3 h-3 sm:w-5 sm:h-5 flex-shrink-0 google-rainbow-icon" aria-hidden="true">
          <defs>
            <linearGradient id="googleRainbow" x1="0%" y1="0%" x2="100%" y2="100%" gradientUnits="userSpaceOnUse">
              <stop offset="0%" stopColor="#EA4335"><animate attributeName="stop-color" values="#EA4335;#FBBC05;#34A853;#4285F4;#EA4335" dur="3s" repeatCount="indefinite"/></stop>
              <stop offset="33%" stopColor="#FBBC05"><animate attributeName="stop-color" values="#FBBC05;#34A853;#4285F4;#EA4335;#FBBC05" dur="3s" repeatCount="indefinite"/></stop>
              <stop offset="66%" stopColor="#34A853"><animate attributeName="stop-color" values="#34A853;#4285F4;#EA4335;#FBBC05;#34A853" dur="3s" repeatCount="indefinite"/></stop>
              <stop offset="100%" stopColor="#4285F4"><animate attributeName="stop-color" values="#4285F4;#EA4335;#FBBC05;#34A853;#4285F4" dur="3s" repeatCount="indefinite"/></stop>
            </linearGradient>
          </defs>
          <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.1z" fill="url(#googleRainbow)"/>
          <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="url(#googleRainbow)"/>
          <path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="url(#googleRainbow)"/>
          <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="url(#googleRainbow)"/>
        </svg>
            ...
            {mobileOpen && (
              <div className="flex flex-col items-center gap-2">
                ...
                <div className="animate-fade-in" style={{ animationDelay: '200ms', animationFillMode: 'both' }}>
                  ...
                  >
                    <svg viewBox="0 0 24 24" className="w-4 h-4 flex-shrink-0 google-rainbow-icon" aria-hidden="true">
                      <defs>
                        <linearGradient id="googleRainbowMobile" x1="0%" y1="0%" x2="100%" y2="100%" gradientUnits="userSpaceOnUse">
                          <stop offset="0%" stopColor="#EA4335"><animate attributeName="stop-color" values="#EA4335;#FBBC05;#34A853;#4285F4;#EA4335" dur="3s" repeatCount="indefinite"/></stop>
                          <stop offset="33%" stopColor="#FBBC05"><animate attributeName="stop-color" values="#FBBC05;#34A853;#4285F4;#EA4335;#FBBC05" dur="3s" repeatCount="indefinite"/></stop>
                          <stop offset="66%" stopColor="#34A853"><animate attributeName="stop-color" values="#34A853;#4285F4;#EA4335;#FBBC05;#34A853" dur="3s" repeatCount="indefinite"/></stop>
                          <stop offset="100%" stopColor="#4285F4"><animate attributeName="stop-color" values="#4285F4;#EA4335;#FBBC05;#34A853;#4285F4" dur="3s" repeatCount="indefinite"/></stop>
                      ...
                      <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.1z" fill="url(#googleRainbowMobile)"/>
                      <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="url(#googleRainbowMobile)"/>
                      <path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="url(#googleRainbowMobile)"/>
                      <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="url(#googleRainbowMobile)"/>
                    </svg>
                    <div className="flex flex-col leading-none">
                      <div className="flex items-center gap-0.5">
                        {[...Array(5)].map((_, i) => (
