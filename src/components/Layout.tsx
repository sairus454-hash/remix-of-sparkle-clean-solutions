  ...
  return (
    <div className="min-h-screen flex flex-col overflow-x-hidden relative">
      ...
      <main id="main-content" role="main" className="flex-1 pt-14 sm:pt-16 lg:pt-20 relative z-10">
        ...
        >
          <svg viewBox="0 0 24 24" className="w-5 h-5 sm:w-7 sm:h-7 flex-shrink-0" aria-hidden="true">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-0.5 sm:gap-1">
              ...
              <span className="text-xs sm:text-sm font-bold text-gray-800 ml-0.5 sm:ml-1">5.0</span>
            </div>
            <span className="text-[10px] sm:text-xs text-gray-500 leading-tight">65 {language === 'pl' ? 'opinii' : language === 'uk' ? 'відгуків' : language === 'ru' ? 'отзывов' : 'reviews'} Google</span>
          </div>
        </a>
      </main>
