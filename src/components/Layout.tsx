    ...
    <div className="min-h-screen flex flex-col overflow-x-hidden relative">
      ...
      <main id="main-content" role="main" className="flex-1 pt-14 sm:pt-16 lg:pt-20 relative z-10">
        ...
        <a
          ...
          className="fixed bottom-44 right-4 sm:bottom-24 sm:right-6 z-30 flex items-center gap-2 bg-white/95 backdrop-blur-sm rounded-xl px-3 py-2 shadow-lg hover:shadow-xl transition-all hover:scale-105 cursor-pointer"
