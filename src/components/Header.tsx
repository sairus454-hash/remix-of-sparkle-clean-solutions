      ...
      <div className="container mx-auto px-2 sm:px-4">
        <div className="flex items-center justify-between h-14 sm:h-16 lg:h-20">
          ...
          <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
            ...
            {/* Phone + Messengers - compact group */}
            <div style={getHeaderItemStyle(14, headerRevealed)} className="flex items-center gap-1 flex-shrink-0">
              <a 
              ...
              <a 
                ...
                className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-[#0088cc] flex items-center justify-center hover:scale-110 transition-transform shadow-sm"
                aria-label="Telegram"
              >
                <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary-foreground" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-[#25D366] flex items-center justify-center hover:scale-110 transition-transform shadow-sm"
                aria-label="WhatsApp"
              >
                <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary-foreground" viewBox="0 0 24 24" fill="currentColor">
