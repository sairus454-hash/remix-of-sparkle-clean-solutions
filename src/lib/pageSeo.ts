...
export const SEO_META: Record<PageKey, Record<Lang, SeoMeta>> = {
  ...
  auto: {
    pl: {
      ...
      description: 'Mobilne pranie tapicerki aut osobowych, busów i kabin TIR. Czyszczenie foteli, podsufitki, dywaników, ozonowanie. Dojazd Wrocław, Opole, Poznań.',
      keywords: 'pranie tapicerki samochodowej, czyszczenie wnętrza auta, kabina TIR, pranie tapicerki busa, ozonowanie auta, detailing Wrocław, Opole, Poznań',
    },
    ru: {
      title: 'Химчистка авто с выездом — салон, TIR, бус | MasterClean',
      description: 'Мобильная химчистка салона легковых авто, бусов и кабин TIR. Чистка сидений, потолка, ковриков, озонирование. Выезд — Вроцлав, Ополе, Познань.',
      keywords: 'химчистка авто, химчистка салона, химчистка кабины TIR, химчистка буса, чистка сидений, озонирование авто Вроцлав, Ополе, Познань',
    },
    uk: {
      title: 'Хімчистка авто з виїздом — салон, TIR, бус | MasterClean',
      description: 'Мобільна хімчистка салону легкових авто, бусів і кабін TIR. Чистка сидінь, стелі, килимків, озонування. Виїзд — Вроцлав, Ополе, Познань.',
      keywords: 'хімчистка авто, хімчистка салону, хімчистка кабіни TIR, хімчистка буса, чистка сидінь, озонування авто Вроцлав, Ополе',
    },
    en: {
      title: 'Mobile Car Interior Cleaning — TIR, Vans | MasterClean',
      description: 'Mobile car interior cleaning for cars, vans and TIR cabins. Seat, ceiling, floor mats and ozone treatment. On-site service — Wrocław, Opole, Poznań.',
      keywords: 'car interior cleaning, mobile car detailing, TIR cabin cleaning, van interior cleaning, car ozone treatment Wrocław, Opole, Poznań',
    },
  },
  ozone: {
    pl: {
      title: 'Ozonowanie mieszkań, biur i aut — MasterClean Wrocław',
      description: 'Profesjonalne ozonowanie pomieszczeń i samochodów. Usuwanie zapachów dymu, pleśni, zwierząt po zalaniu i remoncie. Wrocław, Opole, Poznań.',
      keywords: 'ozonowanie, ozonowanie mieszkania, ozonowanie biura, ozonowanie auta, usuwanie zapachów ozonem, dezynfekcja ozonem Wrocław, Opole, Poznań',
    },
    ru: {
      title: 'Озонирование квартир, офисов и авто — MasterClean Вроцлав',
      description: 'Профессиональное озонирование помещений и автомобилей. Удаление запахов дыма, плесени, животных, после потопа и ремонта. Вроцлав, Ополе.',
      keywords: 'озонирование, озонирование квартиры, озонирование офиса, озонирование авто, удаление запахов озоном, дезинфекция Вроцлав, Ополе, Познань',
    },
    uk: {
      title: 'Озонування квартир, офісів та авто — MasterClean Вроцлав',
      description: 'Професійне озонування приміщень та автомобілів. Усунення запахів диму, плісняви, тварин, після затоплення та ремонту. Вроцлав, Ополе.',
      keywords: 'озонування, озонування квартири, озонування офісу, озонування авто, усунення запахів озоном, дезінфекція Вроцлав, Ополе',
    },
    en: {
      title: 'Ozone Treatment for Homes, Offices & Cars | MasterClean',
      description: 'Professional ozone treatment for rooms and cars. Removes smoke, mould, pet and post-flood odours after renovation. Wrocław, Opole, Poznań.',
      keywords: 'ozone treatment, ozone for apartments, ozone for offices, car ozone, odour removal, ozone disinfection Wrocław, Opole, Poznań',
    },
  },
  prices: {
    pl: {
      title: 'Cennik MasterClean — pranie tapicerki, sprzątanie, okna',
      description: 'Aktualny cennik prania tapicerki, czyszczenia dywanów, materacy, ozonowania, sprzątania i mycia okien. Kalkulator kosztów. Wrocław, Opole, Poznań.',
      keywords: 'cennik prania tapicerki, cennik czyszczenia mebli, cennik ozonowania, cennik sprzątania, cennik mycia okien, ile kosztuje pranie kanapy Wrocław',
    },
    ru: {
      title: 'Цены MasterClean — химчистка, уборка, мойка окон',
      description: 'Актуальные цены на химчистку мебели, ковров, матрасов, озонирование, уборку и мойку окон. Калькулятор стоимости. Вроцлав, Ополе, Познань.',
      keywords: 'цены химчистка мебели, цена чистки дивана, цена озонирования, цена уборки, цена мойки окон, сколько стоит химчистка дивана Вроцлав',
    },
    uk: {
      title: 'Ціни MasterClean — хімчистка, прибирання, миття вікон',
      description: 'Актуальні ціни на хімчистку меблів, килимів, матраців, озонування, прибирання та миття вікон. Калькулятор вартості. Вроцлав, Ополе.',
      keywords: 'ціни хімчистка меблів, ціна чистки дивана, ціна озонування, ціна прибирання, ціна миття вікон, скільки коштує хімчистка дивана Вроцлав',
    },
    en: {
      title: 'MasterClean Pricing — Upholstery, Cleaning, Windows',
      description: 'Up-to-date prices for upholstery, carpet and mattress cleaning, ozone treatment, housekeeping and window washing. Online calculator. Wrocław, Opole.',
      keywords: 'upholstery cleaning prices, sofa cleaning cost, ozone treatment cost, cleaning prices Wrocław, window washing prices Poland',
    },
  },
  contacts: {
    pl: {
      title: 'Kontakt MasterClean — telefon, e-mail, adres Wrocław',
      description: 'Skontaktuj się z MasterClean: tel. +48 575 211 401, czat 24/7, adres ul. Trawowa 14, Wrocław. Zamów pranie tapicerki, ozonowanie lub sprzątanie.',
      keywords: 'kontakt MasterClean, telefon firma sprzątająca Wrocław, zamów pranie tapicerki, adres MasterClean, kontakt czyszczenie mebli Wrocław',
    },
    ru: {
      title: 'Контакты MasterClean — телефон, e-mail, адрес Вроцлав',
      description: 'Свяжитесь с MasterClean: тел. +48 575 211 401, чат 24/7, адрес ul. Trawowa 14, Вроцлав. Закажите химчистку мебели, озонирование или уборку.',
      keywords: 'контакты MasterClean, телефон химчистка Вроцлав, заказать химчистку мебели, адрес MasterClean, контакты уборка Вроцлав',
    },
    uk: {
      title: 'Контакти MasterClean — телефон, e-mail, адреса Вроцлав',
      description: 'Зв’яжіться з MasterClean: тел. +48 575 211 401, чат 24/7, адреса ul. Trawowa 14, Вроцлав. Замовте хімчистку меблів, озонування чи прибирання.',
      keywords: 'контакти MasterClean, телефон хімчистка Вроцлав, замовити хімчистку меблів, адреса MasterClean, контакти прибирання Вроцлав',
    },
    en: {
      title: 'Contact MasterClean — Phone, Email, Wrocław Address',
      description: 'Get in touch with MasterClean: phone +48 575 211 401, 24/7 chat, ul. Trawowa 14, Wrocław. Book upholstery cleaning, ozone treatment or housekeeping.',
      keywords: 'contact MasterClean, cleaning company phone Wrocław, book upholstery cleaning, MasterClean address, cleaning contact Wrocław',
    },
  },
};
...
export const FAQS: Record<PageKey, Record<Lang, Faq[]>> = {
  ...
  prices: {
    ...
    ru: [
      ...
      { q: 'Есть ли доплата за выезд?', a: 'Вроцлав и Смолец — без доплат. Другие города: доплата 10% (сад 5%) и минимум заказа 220 zł.' },
    ...
    uk: [
      ...
      { q: 'Чи є доплата за виїзд?', a: 'Вроцлав і Смолец — без доплат. Інші міста: доплата 10% (сад 5%) і мінімум замовлення 220 zł.' },
  ...
  contacts: {
    ...
    ru: [
      ...
      { q: 'В каких городах оказываете услуги?', a: 'Вроцлав и Смолец без доплат, а также Ополе, Познань, Зелёна Гура, Легница, Калиш и более 30 городов.' },
