  ...
  const categories = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'sofaCornerLarge', name: t.prices.items.sofaCornerLarge, price: 225, originalPrice: 250, image: img('calc-sofa-corner-large.jpg'), promoBadge: '🔥 -10%' },
        { id: 'bedHeadboard', name: t.prices.items.bedHeadboard, price: 90, originalPrice: 100, image: img('calc-headboard.jpg'), promoBadge: '🔥 -10%' },
        { id: 'bedFrame', name: t.prices.items.bedFrame, price: 90, originalPrice: 100, image: img('calc-bedframe.jpg'), promoBadge: '🔥 -10%' },
        { id: 'expressRefresh', name: t.prices.items.expressRefresh, price: 150, image: img('calc-sofa2.jpg') },
      ],
    },
    {
      id: 'leather', title: t.prices.leatherFurnitureTitle, description: t.prices.leatherFurnitureDesc, icon: Armchair,
      items: [
        { id: 'leatherPouf', name: t.prices.items.leatherPouf, price: 50, originalPrice: 55, image: img('calc-leather-pouf.jpg'), promoBadge: '🔥 -10%' },
        { id: 'leatherChair', name: t.prices.items.leatherChair, price: 45, originalPrice: 50, image: img('calc-leather-chair.jpg'), promoBadge: '🔥 -10%' },
        { id: 'leatherPillow', name: t.prices.items.leatherPillow, price: 18, originalPrice: 20, image: img('calc-leather-pouf.jpg'), promoBadge: '🔥 -10%' },
        { id: 'leatherArmchair', name: t.prices.items.leatherArmchair, price: 81, originalPrice: 90, image: img('calc-leather-armchair.jpg'), promoBadge: '🔥 -10%' },
        { id: 'leatherSofa2', name: t.prices.items.leatherSofa2, price: 162, originalPrice: 180, image: img('calc-leather-sofa2.jpg'), promoBadge: '🔥 -10%' },
        { id: 'leatherSofa3', name: t.prices.items.leatherSofa3, price: 198, originalPrice: 220, image: img('calc-leather-sofa3.jpg'), promoBadge: '🔥 -10%' },
        { id: 'leatherSofaCorner', name: t.prices.items.leatherSofaCorner, price: 243, originalPrice: 270, image: img('calc-leather-corner.jpg'), promoBadge: '🔥 -10%' },
      ],
    },
    {
      id: 'mattress', title: t.prices.mattressTitle, description: t.prices.mattressDesc, icon: BedDouble,
      items: [
        { id: 'mattressSingle', name: t.prices.items.mattressSingleDry, price: 126, originalPrice: 140, image: img('calc-mattress-single.jpg'), promoBadge: '🔥 -10%' },
        { id: 'mattressSingleDry2', name: t.prices.items.mattressSingleDry2, price: 198, originalPrice: 220, image: img('calc-mattress-single.jpg'), promoBadge: '🔥 -10%' },
        { id: 'mattressDouble', name: t.prices.items.mattressDoubleDry, price: 162, originalPrice: 180, image: img('calc-mattress-double.jpg'), promoBadge: '🔥 -10%' },
        { id: 'mattressDoubleDry2', name: t.prices.items.mattressDoubleDry2, price: 252, originalPrice: 280, image: img('calc-mattress-double.jpg'), promoBadge: '🔥 -10%' },
        { id: 'expressRefreshM', name: t.prices.items.expressRefresh, price: 150, image: img('calc-mattress-single.jpg') },
      ],
    },
    {
