...
function getFaqData(language: string, cityName: string, isWroclaw: boolean) {
  const faqs = {
    ...
    ru: [
      ...
      { q: `Сколько стоит химчистка мебели в ${cityName}?`, a: isWroclaw ? `Цены начинаются от 36 PLN за пуф. Диван 2-мест. — 140 PLN, 3-мест. — 170 PLN, угловой — от 200 PLN. Минимальный заказ: 160 PLN.` : `Цены в ${cityName} на 10% выше базовых. Например: диван 2-мест. — 155 PLN, 3-мест. — 190 PLN, угловой — от 220 PLN. Минимальный заказ: 220 PLN.` },
    ...
    uk: [
      ...
      { q: `Скільки коштує хімчистка меблів у ${cityName}?`, a: isWroclaw ? `Ціни починаються від 36 PLN за пуф. Диван 2-місний — 140 PLN, 3-місний — 170 PLN, кутовий — від 200 PLN. Мінімальне замовлення: 160 PLN.` : `Ціни в ${cityName} на 10% вищі за базові. Наприклад: диван 2-місний — 155 PLN, 3-місний — 190 PLN, кутовий — від 220 PLN. Мінімальне замовлення: 220 PLN.` },
