...
function getFaqData(language: string, cityName: string, isWroclaw: boolean) {
  const faqs = {
    pl: [
      ...
      { q: `Ile kosztuje pranie tapicerki w ${cityName}?`, a: isWroclaw ? `Ceny zaczynają się od 36 PLN za pufę. Sofa 2-osobowa — 135 PLN, sofa 3-osobowa — 164 PLN, narożnik — od 190 PLN. Minimalne zamówienie: 160 PLN.` : `Ceny w ${cityName} są o 10% wyższe od bazowych cen wrocławskich. Przykładowo: sofa 2-osobowa — 149 PLN, sofa 3-osobowa — 180 PLN. Minimalne zamówienie: 220 PLN.` },
    ...
    ru: [
      ...
      { q: `Сколько стоит химчистка мебели в ${cityName}?`, a: isWroclaw ? `Цены начинаются от 36 PLN за пуф. Диван 2-мест. — 135 PLN, 3-мест. — 164 PLN, угловой — от 190 PLN. Минимальный заказ: 160 PLN.` : `Цены в ${cityName} на 10% выше базовых. Например: диван 2-мест. — 149 PLN, 3-мест. — 180 PLN. Минимальный заказ: 220 PLN.` },
    ...
    en: [
      ...
      { q: `How much does upholstery cleaning cost in ${cityName}?`, a: isWroclaw ? `Prices start from 36 PLN for an ottoman. 2-seater sofa — 135 PLN, 3-seater — 164 PLN, corner sofa — from 190 PLN. Minimum order: 160 PLN.` : `Prices in ${cityName} are 10% higher than base Wrocław prices. Example: 2-seater sofa — 149 PLN, 3-seater — 180 PLN. Minimum order: 220 PLN.` },
    ...
    uk: [
      ...
      { q: `Скільки коштує хімчистка меблів у ${cityName}?`, a: isWroclaw ? `Ціни починаються від 36 PLN за пуф. Диван 2-місний — 135 PLN, 3-місний — 164 PLN, кутовий — від 190 PLN. Мінімальне замовлення: 160 PLN.` : `Ціни в ${cityName} на 10% вищі за базові. Наприклад: диван 2-місний — 149 PLN, 3-місний — 180 PLN. Мінімальне замовлення: 220 PLN.` },
  ...
  const categories = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'armchair', name: t.prices.items.armchair, price: 55, originalPrice: 65, image: img('calc-armchair.jpg'), promoBadge: '🔥 -10%' },
        { id: 'pillow', name: t.prices.items.pillow, price: 10, originalPrice: 10, image: img('calc-pillow.jpg'), promoBadge: '🔥 -10%' },
        { id: 'sofa2', name: t.prices.items.sofa2, price: 120, originalPrice: 135, image: img('calc-sofa2.jpg'), promoBadge: '🔥 -10%' },
        ...
        { id: 'sofaCornerLarge', name: t.prices.items.sofaCornerLarge, price: 205, originalPrice: 225, image: img('calc-sofa-corner-large.jpg'), promoBadge: '🔥 -10%' },
        { id: 'bedHeadboard', name: t.prices.items.bedHeadboard, price: 75, originalPrice: 80, image: img('calc-headboard.jpg'), promoBadge: '🔥 -10%' },
        { id: 'bedFrame', name: t.prices.items.bedFrame, price: 75, originalPrice: 80, image: img('calc-bedframe.jpg'), promoBadge: '🔥 -10%' },
