...
function getFaqData(language: string, cityName: string, isWroclaw: boolean) {
  const faqs = {
    pl: [
      ...
      { q: `Ile kosztuje pranie tapicerki w ${cityName}?`, a: isWroclaw ? `Ceny zaczynają się od 36 PLN za pufę. Sofa 2-osobowa — 126 PLN, sofa 3-osobowa — 153 PLN, narożnik — od 180 PLN. Minimalne zamówienie: 180 PLN.` : `Ceny w ${cityName} są o 10% wyższe od bazowych cen wrocławskich. Przykładowo: sofa 2-osobowa — 139 PLN, sofa 3-osobowa — 169 PLN. Minimalne zamówienie: 300 PLN.` },
    ...
    ru: [
      ...
      { q: `Сколько стоит химчистка мебели в ${cityName}?`, a: isWroclaw ? `Цены начинаются от 36 PLN за пуф. Диван 2-мест. — 126 PLN, 3-мест. — 153 PLN, угловой — от 180 PLN. Минимальный заказ: 180 PLN.` : `Цены в ${cityName} на 10% выше базовых. Например: диван 2-мест. — 139 PLN, 3-мест. — 169 PLN. Минимальный заказ: 300 PLN.` },
    ...
    en: [
      ...
      { q: `How much does upholstery cleaning cost in ${cityName}?`, a: isWroclaw ? `Prices start from 36 PLN for an ottoman. 2-seater sofa — 126 PLN, 3-seater — 153 PLN, corner sofa — from 180 PLN. Minimum order: 180 PLN.` : `Prices in ${cityName} are 10% higher than base Wrocław prices. Example: 2-seater sofa — 139 PLN, 3-seater — 169 PLN. Minimum order: 300 PLN.` },
    ...
    uk: [
      ...
      { q: `Скільки коштує хімчистка меблів у ${cityName}?`, a: isWroclaw ? `Ціни починаються від 36 PLN за пуф. Диван 2-місний — 126 PLN, 3-місний — 153 PLN, кутовий — від 180 PLN. Мінімальне замовлення: 180 PLN.` : `Ціни в ${cityName} на 10% вищі за базові. Наприклад: диван 2-місний — 139 PLN, 3-місний — 169 PLN. Мінімальне замовлення: 300 PLN.` },
