...
const Prices = () => {
  ...
  const allCategories = [
    ...
    },
    {
      ...META.furniture,
      items: [
        { id: 'pouf', name: t.prices.items.pouf, price: 40, image: img('calc-pouf.jpg') },
        { id: 'chairSeat', name: t.prices.items.chairSeat, price: 20, image: img('calc-chair-seat.jpg') },
        { id: 'chairWithBack', name: t.prices.items.chairWithBack, price: 30, image: img('calc-chair-back.jpg') },
        { id: 'chairConference', name: t.prices.items.chairConference, price: 40, image: img('calc-chair-conference.jpg') },
        { id: 'chairSwivel', name: t.prices.items.chairSwivel, price: 50, image: img('calc-chair-swivel.jpg') },
        { id: 'chair', name: t.prices.items.chair, price: 30, image: img('calc-chair.jpg') },
        { id: 'armchair', name: t.prices.items.armchair, price: 80, image: img('calc-armchair.jpg') },
        { id: 'pillow', name: t.prices.items.pillow, price: 10, image: img('calc-pillow.jpg') },
        { id: 'sofa2', name: t.prices.items.sofa2, price: 150, image: img('calc-sofa2.jpg') },
        { id: 'sofa3', name: t.prices.items.sofa3, price: 170, image: img('calc-sofa3.jpg') },
        { id: 'sofaCorner', name: t.prices.items.sofaCorner, price: 200, image: img('calc-sofa-corner.jpg') },
        { id: 'sofaCornerLarge', name: t.prices.items.sofaCornerLarge, price: 240, image: img('calc-sofa-corner-large.jpg') },
        { id: 'kitchenCorner', name: t.prices.items.kitchenCorner, price: 150, image: img('calc-kitchen-corner.jpg') },
        { id: 'bedHeadboard', name: t.prices.items.bedHeadboard, price: 90, image: img('calc-headboard.jpg') },
        { id: 'bedFrame', name: t.prices.items.bedFrame, price: 90, image: img('calc-bedframe.jpg') },
    ...
    },
    {
      ...META.mattress,
      items: [
        { id: 'mattressSingle', name: t.prices.items.mattressSingleDry, price: 130, image: img('calc-mattress-single.jpg') },
        { id: 'mattressSingleDry2', name: t.prices.items.mattressSingleDry2, price: 200, image: img('calc-mattress-single.jpg') },
        { id: 'mattressDouble', name: t.prices.items.mattressDoubleDry, price: 200, image: img('calc-mattress-double.jpg') },
        { id: 'mattressDoubleDry2', name: t.prices.items.mattressDoubleDry2, price: 270, image: img('calc-mattress-double.jpg') },
    ...
    },
    {
      ...META.leather,
      items: [
        { id: 'leatherPouf', name: t.prices.items.leatherPouf, price: 50, image: img('calc-leather-pouf.jpg') },
        { id: 'leatherChair', name: t.prices.items.leatherChair, price: 50, image: img('calc-leather-chair.jpg') },
        { id: 'leatherPillow', name: t.prices.items.leatherPillow, price: 20, image: img('calc-leather-pouf.jpg') },
        { id: 'leatherArmchair', name: t.prices.items.leatherArmchair, price: 90, image: img('calc-leather-armchair.jpg') },
        { id: 'leatherSofa2', name: t.prices.items.leatherSofa2, price: 160, image: img('calc-leather-sofa2.jpg') },
        { id: 'leatherSofa3', name: t.prices.items.leatherSofa3, price: 200, image: img('calc-leather-sofa3.jpg') },
        { id: 'leatherSofaCorner', name: t.prices.items.leatherSofaCorner, price: 250, image: img('calc-leather-corner.jpg') },
        { id: 'leatherChairSwivel', name: t.prices.items.leatherChairSwivel, price: 70, image: img('calc-leather-chair-swivel.jpg') },
      ],
    },
    {
      ...META.auto,
