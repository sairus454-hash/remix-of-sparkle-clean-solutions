  ...
  const allCategories = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'armchair', name: t.prices.items.armchair, price: 70, image: img('calc-armchair.jpg') },
        { id: 'pillow', name: t.prices.items.pillow, price: 5, image: img('calc-pillow.jpg') },
        { id: 'sofa2', name: t.prices.items.sofa2, price: 140, image: img('calc-sofa2.jpg') },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'tileCleaning', name: t.prices.items.tileCleaning, price: 15, image: img('calc-tile-cleaning.jpg'), unit: 'm²' },
        { id: 'woodFloorCleaning', name: t.prices.items.woodFloorCleaning, price: 15, image: img('calc-wood-floor-cleaning.jpg'), unit: 'm²' },
