...
import {
  ...
  Sofa, Sparkles, Calculator, Wrench, ChevronDown, Star, Award
} from 'lucide-react';
import {
  ...
  const categories = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'chair', name: t.prices.items.chair, price: 40, image: img('calc-chair.jpg') },
        ...
        { id: 'sofaCornerLarge', name: t.prices.items.sofaCornerLarge, price: 250, image: img('calc-sofa-corner-large.jpg') },
    ...
    },
    {
      ...
      items: [
        { id: 'leatherPouf', name: t.prices.items.leatherPouf, price: 55, image: img('calc-leather-pouf.jpg') },
        ...
        { id: 'leatherSofa2', name: t.prices.items.leatherSofa2, price: 180, image: img('calc-leather-sofa2.jpg') },
        { id: 'leatherSofa3', name: t.prices.items.leatherSofa3, price: 220, image: img('calc-leather-sofa3.jpg') },
        { id: 'leatherSofaCorner', name: t.prices.items.leatherSofaCorner, price: 270, image: img('calc-leather-corner.jpg') },
      ],
    },
    {
      id: 'mattress', title: t.prices.mattressTitle, description: t.prices.mattressDesc, icon: BedDouble,
      items: [
        { id: 'mattressSingle', name: t.prices.items.mattressSingleDry, price: 140, image: img('calc-mattress-single.jpg') },
        { id: 'mattressSingleDry2', name: t.prices.items.mattressSingleDry2, price: 220, image: img('calc-mattress-single.jpg') },
        { id: 'mattressDouble', name: t.prices.items.mattressDoubleDry, price: 180, image: img('calc-mattress-double.jpg') },
        { id: 'mattressDoubleDry2', name: t.prices.items.mattressDoubleDry2, price: 280, image: img('calc-mattress-double.jpg') },
