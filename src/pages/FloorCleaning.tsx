...
const FloorCleaning = () => {
  ...
  const copy = {
    pl: {
      ...
      faqs: [
        { q: 'Ile kosztuje pranie dywanu lub wykładziny?', a: 'Cena zależy od metrażu i rodzaju zabrudzeń. Wykładzina dywanowa 1-20 m² — 15 zł/m², 20-50 m² — 10 zł/m², powyżej 50 m² — 7-10 zł/m². Pranie dywanu z odbiorem do pralni — 30 zł/m². Czyszczenie płytek ceramicznych — 15 zł/m². Impregnacja dywanu — 5 zł/m². Cena jest taka sama we wszystkich miastach (bez markupu).' },
    ...
    ru: {
      ...
      faqs: [
        { q: 'Сколько стоит химчистка ковра или ковролина?', a: 'Цена зависит от площади и типа покрытия. Ковролин 1-20 м² — 15 zł/м², 20-50 м² — 10 zł/м², свыше 50 м² — 7-10 zł/м². Стирка ковра с забором в прачечную — 30 zł/м². Чистка керамической плитки — 15 zł/м². Импрегнация ковра — 5 zł/м². Цена одинаковая во всех городах (без наценки).' },
    ...
    en: {
      ...
      faqs: [
        { q: 'How much does carpet or fitted-carpet cleaning cost?', a: 'Price depends on area and covering type. Fitted carpet 1-20 m² — 15 zł/m², 20-50 m² — 10 zł/m², over 50 m² — 7-10 zł/m². Rug cleaning with pickup — 30 zł/m². Ceramic tile cleaning — 15 zł/m². Carpet impregnation — 5 zł/m². The price is the same in every city (no surcharge).' },
    ...
    uk: {
      ...
      faqs: [
        { q: 'Скільки коштує хімчистка килима або ковроліну?', a: 'Ціна залежить від площі та типу покриття. Ковролін 1-20 м² — 15 zł/м², 20-50 м² — 10 zł/м², понад 50 м² — 7-10 zł/м². Прання килима із забором — 30 zł/м². Чистка керамічної плитки — 15 zł/м². Імпрегнація килима — 5 zł/м². Ціна однакова в усіх містах (без націнки).' },
