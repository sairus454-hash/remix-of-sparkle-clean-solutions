  ...
  return <>
      ...
      <section className="relative w-full overflow-hidden" style={{ height: '80vh', padding: 0, maxWidth: 'none' }}>
        ...
        <a
          ...
          className="absolute bottom-6 right-6 sm:top-8 sm:bottom-auto sm:right-8 z-20 flex items-center gap-2.5 bg-white/95 backdrop-blur-sm rounded-xl px-4 py-3 shadow-lg hover:shadow-xl transition-all hover:scale-105 cursor-pointer"
