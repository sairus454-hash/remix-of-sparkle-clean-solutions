...
const Index = () => {
  ...
  const stats = [
    { icon: Star, value: '3+', label: t.about.experience },
    { icon: Users, value: '5000+', label: t.about.clients },
    { icon: Award, value: '100%', label: t.about.quality },
  ];
    ...
    <>
      ...
      <section className="relative min-h-[90vh] flex items-center bg-gradient-section overflow-hidden">
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-fresh/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '3s' }} />
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="max-w-xl">
              ...
              <div className="flex justify-start mb-6 animate-fade-up">
                <div className="relative">
                  ...
                  <div className="absolute top-0 right-0 w-4 h-4 bg-primary/70 rounded-full animate-ping" style={{ animationDelay: '0.2s' }} />
                  <div className="absolute bottom-0 left-0 w-3 h-3 bg-fresh rounded-full animate-ping" style={{ animationDelay: '0.4s' }} />
                  <div className="absolute top-0 left-0 w-3 h-3 bg-primary rounded-full animate-ping" style={{ animationDelay: '0.6s' }} />
                  <div className="absolute bottom-0 right-0 w-4 h-4 bg-fresh/80 rounded-full animate-ping" style={{ animationDelay: '0.8s' }} />
                </div>
              </div>
              <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold mb-6 animate-fade-up bg-gradient-to-r from-primary via-fresh to-primary bg-clip-text text-transparent bg-[length:200%_auto]" style={{ animation: 'float 3s ease-in-out infinite, shimmer 3s linear infinite' }}>
                {t.hero.title}
              </h1>
            ...
            <div className="relative animate-fade-up group" style={{ animationDelay: '0.3s' }}>
              <div className="aspect-[4/3] rounded-2xl bg-gradient-hero p-1 shadow-glow overflow-hidden" style={{ animation: 'float 4s ease-in-out infinite' }}>
                <div className="relative w-full h-full rounded-2xl overflow-hidden">
                  <img 
                    src={mattressCleaningImage} 
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {stats.map((stat, index) => (
              <div 
                key={index} 
                className="flex items-center justify-center gap-4 p-6 rounded-2xl bg-gradient-card shadow-card animate-fade-up"
              ...
              >
                <div className="w-14 h-14 rounded-xl bg-gradient-hero flex items-center justify-center shadow-glow" style={{ animation: 'float 3s ease-in-out infinite' }}>
                  <stat.icon className="w-7 h-7 text-primary-foreground" style={{ animation: 'pulse 2s ease-in-out infinite' }} />
                </div>
                <div>
      ...
      <section className="py-20 bg-card">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="font-serif text-3xl md:text-4xl font-bold mb-6 animate-[float_3s_ease-in-out_infinite] bg-gradient-to-r from-primary via-fresh to-primary bg-clip-text text-transparent bg-[length:200%_auto]" style={{ animation: 'float 3s ease-in-out infinite, shimmer 3s linear infinite' }}>
                {t.about.title}
              </h2>
              <p className="text-muted-foreground mb-8">{t.about.description}</p>
              
              <ul className="space-y-4">
                {[t.equipment.modern, t.equipment.eco, t.equipment.quality].map((item, index) => (
                  <li key={index} className="flex items-center gap-3">
                    <CheckCircle2 className="w-5 h-5 text-fresh" style={{ animation: 'pulse 2s ease-in-out infinite' }} />
            ...
            <div className="relative group">
              <div className="aspect-square rounded-2xl bg-gradient-hero p-1 shadow-glow overflow-hidden" style={{ animation: 'float 5s ease-in-out infinite' }}>
                <div className="relative w-full h-full rounded-2xl overflow-hidden">
                  <img 
                    src={heroImage} 
                    alt="MasterClean" 
