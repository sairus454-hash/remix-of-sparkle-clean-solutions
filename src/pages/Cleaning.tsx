...
const Cleaning = () => {
  ...
  return (
    <>
      <SEO
        title="Sprzątanie mieszkań i domów — cała Polska"
        description="Sprzątanie mieszkań, domów i biur z dojazdem. Generalne, standardowe i po remoncie. Eko środki. Cała Polska. Oblicz koszt online."
        keywords="sprzątanie mieszkań, sprzątanie domów, sprzątanie biur, sprzątanie generalne, sprzątanie standardowe, sprzątanie po remoncie, firma sprzątająca, usługi sprzątania, sprzątanie z dojazdem, sprzątanie Polska, sprzątanie Dolny Śląsk, sprzątanie Opole, sprzątanie po budowie, sprzątanie przed wynajmem, house cleaning Poland"
        canonical="/cleaning"
