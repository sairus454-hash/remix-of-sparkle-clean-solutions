...
const blogTitles = {
  ru: { title: 'Блог чистоты', subtitle: 'Полезные статьи о химчистке, уборке и уходе за вещами', back: 'На главную' },
  en: { title: 'Cleanliness Blog', subtitle: 'Useful articles about cleaning and care', back: 'Back to Home' },
  pl: { title: 'Blog czystości', subtitle: 'Przydatne artykuły o czyszczeniu i pielęgnacji', back: 'Strona główna' },
  uk: { title: 'Блог чистоти', subtitle: 'Корисні статті про хімчистку, прибирання та догляд', back: 'На головну' },
};
